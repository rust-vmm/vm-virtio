...
mod tests {
    ...
    fn test_consume_chains_with_notif() {
        ...
        for i in 0..13 {
            ...
            descs.push(Descriptor::from(SplitDescriptor::new(
                (0x1000 * (i + 1)) as u64,
                0x1000,
                flags as u16,
                i + 1,
    ...
    fn test_iterator() {
        ...
        // total)
        {
            let descs = vec![
                ...
                Descriptor::from(SplitDescriptor::new(0x1000, 0x1234_5678, 0, 2)),
            ];
            vq.add_desc_chains(&descs, 0).unwrap();
        ...
        {
            let descs = vec![Descriptor::from(SplitDescriptor::new(
                0x1000,
                0xffff_ffff,
                VRING_DESC_F_NEXT as u16,
                0,
    ...
    fn test_regression_iterator_division() {
        ...
        let descriptors: Vec<Descriptor> = vec![Descriptor::from(SplitDescriptor::new(
    ...
    fn test_regression_timeout_after_reset() {
        ...
        let descriptors: Vec<Descriptor> = vec![
            Descriptor::from(SplitDescriptor::new(21508325467, 0, 1, 4)),
            Descriptor::from(SplitDescriptor::new(2097152, 4096, 3, 0)),
            Descriptor::from(SplitDescriptor::new(
            ...
            Descriptor::from(SplitDescriptor::new(76842670169653248, 1114115, 0, 0)),
            Descriptor::from(SplitDescriptor::new(16, 983040, 126, 3)),
            Descriptor::from(SplitDescriptor::new(897648164864, 0, 0, 0)),
            Descriptor::from(SplitDescriptor::new(111669149722, 0, 0, 0)),
        ];
